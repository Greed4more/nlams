...
import { formatINRFull, formatCrore, proposals } from "@/data/mockData";
...
export function CompensationCalculator() {
  ...
  const result = useMemo(
    ...
    [areaHa, marketValuePerHa, classification, distance, trees, structures, wells, siaDate, awardDate],
  );
    ...
    <div>
      ...
      <section className="panel p-4">
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          >
            <div className={cn("pt-2", classification === "URBAN" && "pointer-events-none opacity-45")}>
              <Slider
                value={[distance]}
                min={0}
                max={50}
